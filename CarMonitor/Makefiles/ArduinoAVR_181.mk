...
#
#
# Last update: Jun 16, 2018 release 9.4.4
...
BUILD_CORE       := avr
SUB_PLATFORM     := avr
PLATFORM_TAG      = ARDUINO=10803 ARDUINO_ARCH_AVR ARDUINO_$(BUILD_BOARD) EMBEDXCODE=$(RELEASE_NOW) $(filter __%__ ,$(GCC_PREPROCESSOR_DEFINITIONS))
APPLICATION_PATH := $(ARDUINO_PATH)
...
CPPFLAGS    += -ffunction-sections -fdata-sections -flto -MMD
