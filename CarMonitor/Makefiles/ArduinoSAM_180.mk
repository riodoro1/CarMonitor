...
#
#
# Last update: Apr 20, 2017 release 7.3.6
...
ifneq ($(call PARSE_FILE,$(BOARD_TAG),name,$(ARDUINO_180_SAM_BOARDS)),)
MAKEFILE_NAME = ArduinoSAM_180
...
PLATFORM         := Arduino
BUILD_CORE       := sam
PLATFORM_TAG      = ARDUINO=10801 ARDUINO_ARCH_SAM EMBEDXCODE=$(RELEASE_NOW) ARDUINO_$(BUILD_BOARD) $(filter __%__ ,$(GCC_PREPROCESSOR_DEFINITIONS))
...
COMMAND_LINK    = $(CC) $(LDFLAGS) $(OUT_PREPOSITION)$@ -L$(OBJDIR) -Wl,--start-group $(UFLAGS) $(FIRST_O_IN_LD) $(SYSTEM_OBJS) $(LOCAL_OBJS) $(TARGET_A) -Wl,--end-group -lm -lgcc
